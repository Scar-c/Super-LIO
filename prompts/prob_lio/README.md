...
| P13 | `prompt13_covariance_authority_mcd_oxford_m3.md` | dataset covariance authority corrective, Oxford official FAST-LIVO2 semantics, MCD day10/night08 reruns, M3 Outdoor provenance | generalization/covariance authority | CLOSED — 18 current canonical cells; M3 Outdoor blocked |
