...
| `prob_lio/prompt2_P0_eval_closure_P1_point_probability.md` | P0-2 / P1-1 | P0 evaluator/parity closure → P1 current point probability | Commit A `4040875` (P0 closure) + Commit B `764488b` (P1) |
