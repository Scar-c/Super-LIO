...
| 17 | 04_v1_implementation/17_round11_visual_frontend_corrective_before_mode_a.md | Super-LIVO_Round11_VisualFrontend_Corrective_Before_ModeA_DS | ACTIVE（V-0C corrective） | Freeze architecture, repair visual frontend (image-grid selection, parent coupling, full trigger, 6DOF FD) before MODE-A | 5bba1cf | 本轮产出 | gates A-L → V-4 → ATE | — |
