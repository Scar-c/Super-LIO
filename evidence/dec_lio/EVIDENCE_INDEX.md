...
only this index and its README. `prompt02/EVIDENCE_MIGRATION_MANIFEST.md`
records the historical Prompt00R/Prompt01 path moves with old and new blob
identities.
