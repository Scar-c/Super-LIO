...
| sequence | rank/frame | mode, rho | c_L / c_tight | suppression | objective reduction | ΔATE 5/10/20 s | classification |
|---|---:|---|---:|---:|---:|---|---|
| stairs_alpha | 1 / 239 | R0, .079 | -.003988 / -.001911 | .479 | 217.3 | +.0118 / +.0149 / +.0115 | PERSISTENT_HARM |
| stairs_alpha | 2 / 1461 | T0, .081 | +.01467 / +.003131 | .213 | 2069.3 | +.0239 / +.0118 / +.0070 | PERSISTENT_HARM |
| stairs_alpha | 3 / 3293 | R0, .084 | -.001224 / -.0000148 | .012 | 87.4 | +.0005 / +.0001 / +.0006 | RECOVERS |
| stairs_alpha | 4 / 3769 | R0, .055 | +.001164 / +.0003617 | .311 | 410.0 | +.0000 / +.0001 / +.0002 | MIXED |
| stairs_alpha | 5 / 5169 | R0, .026 | +.003188 / -.0004721 | .148 | 205.1 | +.0010 / -.0001 / -.0002 | RECOVERS |
| tunnel1_gamma | 1 / 227 | R0, .005 | -.0001342 / +.0000401 | .299 | 171.1 | NA / NA / NA | UNAVAILABLE |
| tunnel1_gamma | 2 / 545 | R0, .005 | -.0000806 / -.0000282 | .350 | 33.3 | NA / NA / NA | UNAVAILABLE |
| tunnel1_gamma | 3 / 865 | R0, .006 | +.0001500 / +.0000562 | .375 | 75.9 | NA / NA / NA | UNAVAILABLE |
| tunnel1_gamma | 4 / 1173 | R0, .014 | +.0001396 / +.0000406 | .291 | 20.0 | +.0002 / -.0003 / -.0001 | MIXED |
