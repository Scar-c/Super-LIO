#!/usr/bin/env python3
# Provenance: ported from origin/super-livo:scripts/super_livo/evaluation/eval_m3dgr_aruco.py.
# Upstream M3DGR ArUco_evaluate.py revision and SHA256 are pinned below.
