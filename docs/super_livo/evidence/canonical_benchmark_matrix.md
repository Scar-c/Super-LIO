...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| NTU | eee_01 | AVAILABLE | Leica prism; dataset-author interpolation; SE3; translation ATE RMSE | paper Table I 0.119 m (A) | NOT_FOUND | 0.118876 m, canonical | paper 0.068 m + current-source 0.0271 m (both B) | NOT_FOUND | 0.0303 m, canonical | 0.1057 legacy | 0.1024 legacy | 0.0900 legacy | NOT_RUN | NOT_REEVALUATED | D_VISUAL_SHADOW MEASUREMENT ACTIVE at FULL_LIDAR_OBSERVE_CALLBACK (Prompt60; camera-epoch placement NOT_ESTABLISHED; apply OFF; ATE not evaluated) |
...
| M3DGR | Corridor02 | AVAILABLE | same | NOT_FOUND | NOT_FOUND | NOT_RUN_NO_AUTHORITATIVE_CONFIG | NOT_FOUND | NO_AUTHORITATIVE_REFERENCE | EXECUTION_VALID=YES ALGORITHM_OUTCOME=DIVERGED NUMERIC_RESULT=NOT_CONSUMED (22.9 km diagnostic) | NOT_RUN | NOT_RUN | NOT_RUN | NOT_RUN | NOT_RUN | NOT_RUN |
