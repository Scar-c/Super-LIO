...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| NTU | eee_01 | AVAILABLE | Leica prism; dataset-author interpolation; SE3; translation ATE RMSE | paper Table I 0.119 m (A) | NOT_FOUND | 0.118876 m, canonical | paper 0.068 m + current-source 0.0271 m (both B) | NOT_FOUND | 0.0303 m, canonical | 0.1057 legacy | 0.1024 legacy | 0.0900 legacy | NOT_RUN | NOT_REEVALUATED | D_VISUAL_SHADOW ESTABLISHED (lifecycle+measurement ACTIVE, apply OFF; ATE not evaluated) |
