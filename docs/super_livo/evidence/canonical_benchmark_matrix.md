...
| NTU | sbs_01 | AVAILABLE | same | paper 0.086 m (A) | NOT_FOUND | 0.084422872 m, canonical GREEN | paper Table II 0.062 m + current-source 0.0234 m (both B) | NOT_FOUND | PENDING_THIS_CLOSURE | 0.1040 legacy | 0.1034 legacy | 0.1101 legacy | 0.1083 legacy | NOT_RUN | NOT_RUN |
